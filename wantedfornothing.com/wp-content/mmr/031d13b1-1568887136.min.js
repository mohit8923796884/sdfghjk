...
this._update(curr);return this};Tween.prototype.update=function(fn){if(0==arguments.length)return this.step();this._update=fn;return this};module.exports=Tween},{"./ease":11,"./emitter":12}],16:[function(require,module,exports){;(function(exports){'use strict';function EventEmitter(){}
